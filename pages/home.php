<main class="page">
    ...
    <section class="feature-grid">
        ...
        <div class="feature-container">
            <a href="" class="feature-card">
                <div class="card-icon"><img src="/MILKYWAY/public/images/home-book.png" alt="Latch Library"></div>
                <div class="card-text">
                    <h3>Latch Library</h3>
                    <p>Articles</p>
                </div>
        ...
        <div class="feature-container">
            <a href="" class="feature-card">
                <div class="card-icon"><img src="/MILKYWAY/public/images/home-community.png" alt="MomMates"></div>
                <div class="card-text">
                    <h3>MomMates</h3>
                    <p>Community</p>
                </div>
    ...
    <section class="daily-tip">
        <h2>Daily Tip</h2>
        <p>Stay hydrated! Drinking plenty of water helps maintain your milk supply and keeps you energized throughout the day.</p>
    </section>
