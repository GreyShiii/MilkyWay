...
<main class="page about-page">
  ...
  <section class="about-hero">
    <div class="about-hero-inner">
      <img class="about-logo" src="public/images/logo-name.png" alt="Milky Way">
  ...
  <section class="about-team">
    ...
    <div class="team-grid team-grid-top">
      ...
      <div class="team-card">
        <div class="team-avatar">
          <img src="public/images/about/arvin.png" alt="Lingal Arvin M.">
        </div>
      ...
      <div class="team-card">
        <div class="team-avatar">
          <img src="public/images/about/james.png" alt="Macatangay, James">
        </div>
    ...
    <div class="team-grid team-grid-bottom">
      ...
      <div class="team-card">
        <div class="team-avatar">
          <img src="public/images/about/sheryll.png" alt="Galit, Sheryll R.">
        </div>
      ...
      <div class="team-card team-card-feature">
        <div class="team-avatar team-avatar-feature">
          <img src="public/images/about/marielle.png" alt="Bauto, Marielle P.">
        </div>
      ...
      <div class="team-card">
        <div class="team-avatar">
          <img src="public/images/about/krisnadasi.png" alt="Felix, Krishnadasi M.">
        </div>
